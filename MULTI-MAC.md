...
| | |
|---|---|
| GitHub | `maf4711/meister8` |
| SSH | `git@github.com:maf4711/meister8.git` |
| Remote dieses Checkouts | `git@github.com:maf4711/meister8.git` |
| Ordner | `~/Developer/meister8` |
| Default-Branch | `main` |
...
3. Dieser Checkout liegt danach unter `~/Developer/meister8`. Weicht der Ordner vom Repo-Namen ab, weil zwei Orgs denselben Namen haben, heißt er `~/Developer/<owner>--<name>`.
